        ...
        <>  
            {
                !succeeded && (
                <div>
                    {coupon && totalAfterDiscount !== undefined ? <p className="alert alert-success">{`Total after discount: ₹ ${totalAfterDiscount}`}</p> : <p className="aler alert-danger">No coupon applied</p>}
                </div>)
            }
